...
const aceptarOferta = async (idOferta) => {
    ...
    try{
        ...
        console.log('Error al intentar aceptar la oferta'+error)
    }
}
...
const actualizaCardOferta = (idOferta, estatus) => {
    ...
    bold.textContent = 'Estatus: '
    const span = document.createElement('span')
    span.classList.add(estatus)
    span.textContent = estatus
    const contenedor = oferta.querySelector('.estatus')
    contenedor.replaceChildren(bold, span)
}
